...
class TestLecturer {
	...
	@Test
	void testGetID() {
		assertEquals(lecturer1.getID(), 1);
	}
	...
	void testSetModulesTeaching() {
		ArrayList<Module> moduleArrayList = new ArrayList<Module>(Arrays.asList(
												new Module("modA", "MA123", "Bill_Gates"),
												new Module("modB", "MA234", "Bill_Gates"),
												new Module("modC", "MA345", "Bill_Gates")));
	...
	@Test
	void testAddModule() {
		Module module = new Module("modD", "MA456", "Bill_Gates");
	...
	void testRemoveModule() {
		Module module = new Module("modB", "MA234", "Bill_Gates");
		ArrayList<Module> currentModules = lecturer1.getModulesTeaching();
