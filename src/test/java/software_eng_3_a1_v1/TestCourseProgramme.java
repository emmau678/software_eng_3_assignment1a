...
class TestCourseProgramme {
	...
	void testSetModules() {
		ArrayList<Module> moduleArrayList = new ArrayList<Module>(Arrays.asList(
												new Module("moduleA", "CS123", new Lecturer("lecturer1", 40, "22/09/1982")),
												new Module("moduleB", "CS234", new Lecturer("lecturer2", 50, "22/09/1972")),
												new Module("moduleC", "CS345", new Lecturer("lecturer3", 60, "22/09/1962"))));
	...
	@Test
	void testAddModule() {
		Module module = new Module("moduleD", "CS456", new Lecturer("lecturer4", 45, "22/09/1977"));
	...
	void testRemoveModule() {
		Module module = new Module("moduleB", "CS234", new Lecturer("lecturer2", 50, "22/09/1972"));
		ArrayList<Module> currentModules = compsci.getModules();
