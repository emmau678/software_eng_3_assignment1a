...
class TestStudent {
	...
	void testSetModules() {
		ArrayList<Module> moduleArrayList = new ArrayList<Module>(Arrays.asList(
												new Module("modA", "CT123", "dr1"),
												new Module("modB", "CT234", "dr2"),
												new Module("modC", "CT345", "dr3")));
	...
	@Test
	void testAddModule() {
		Module module = new Module("modD", "CT456", "dr4");
	...
	void testRemoveModule() {
		Module module = new Module("modB", "CT234", "dr2");
		ArrayList<Module> currentModules = student1.getModules();
